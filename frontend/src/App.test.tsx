  ...
  it("una entrega ya analizada vuelve a abrir la revisión guardada, sin volver a analizar", async () => {
    ...
    const RESULTADO_GUARDADO = {
      ...
      informe: {
        ...
        sintesis_provisional: "Síntesis provisional guardada de una revisión anterior.",
        ...
        semaforo_propuesto: "GRIS",
        semaforo_final_docente: null, recomendacion: null,
        nota_propuesta_sistema: null, estado_nota: "pendiente_de_rubrica" as const,
