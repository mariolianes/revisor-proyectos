    ...
    it("al analizar, abre la revisión con el resultado del análisis", async () => {
      ...
      const RESULTADO = {
        ...
        informe: {
          ...
          continuidad: [], continuidad_nota: null,
          dimensiones_ausentes: [], semaforo_propuesto: "GRIS",
          semaforo_final_docente: null, recomendacion: null,
          nota_propuesta_sistema: null,
          estado_nota: "pendiente_de_rubrica" as const,
          version_rubrica: null, ponderaciones_nota: null,
          nota_final_docente: null, motivo_modificacion_nota: null,
          motor: "simulado",
        },
  ...
  describe("la confirmación de protección de datos (428)", () => {
    ...
    const RESULTADO = {
      ...
      informe: {
        ...
        dimensiones_ausentes: [], semaforo_propuesto: "GRIS",
        semaforo_final_docente: null, recomendacion: null,
        sintesis_provisional: "", nota_propuesta_sistema: null,
        estado_nota: "pendiente_de_rubrica" as const, version_rubrica: null,
        ponderaciones_nota: null, nota_final_docente: null,
